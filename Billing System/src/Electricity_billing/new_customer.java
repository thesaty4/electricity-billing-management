...
JLabel j1,j2,j3,j4,j5,j6,j7,j8,j9;
	...
	new_customer()
	{
		...
		f1=new Font("rockwell",Font.BOLD,30);
		...
		j9=new JLabel("New Customer Detail");
		j9.setFont(f1);
		...
		ImageIcon img=new ImageIcon(ClassLoader.getSystemResource("Electricity_billing/image/logo1.png"));
		Image image=img.getImage().getScaledInstance(270,300,Image.SCALE_DEFAULT);
	...
	public void actionPerformed(ActionEvent ev)
	{
              if(ev.getSource()==b1)
		{
                 	...
                 	try
			{
			  ...
			  String q="insert into customer_info(`name`,`address`,`state`,`city`,`email`,`phone`) values('"+name+"' , '"+address+"' , '"+state+"' , '"+city+"' , '"+email+"' , '"+phone+"')";
